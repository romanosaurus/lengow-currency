...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','script_test.py',47),
  ('expr -> expr MINUS expr','expr',3,'p_sub','script_test.py',51),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','script_test.py',55),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','script_test.py',59),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','script_test.py',60),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','script_test.py',71),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','script_test.py',75),
]
